    ...
    <div className="min-h-screen gradient-hero flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Learn Smarter. Score Higher. Grow Faster.</p>
        </div>
        ...
        <p className="text-center text-xs text-muted-foreground mt-4">
          Founded by <span className="font-medium text-foreground">Uzair Ahmad</span>
        </p>
      </motion.div>
    </div>
  );
