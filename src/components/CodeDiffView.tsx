...
const CodeDiffView = ({ originalCode, fixedCode, errorMsg, language, copied, onCopy }: CodeDiffViewProps) => {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Split diff view — stacked on mobile, side-by-side on desktop */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-xl overflow-hidden border border-border/30">
        {/* Left: Original */}
