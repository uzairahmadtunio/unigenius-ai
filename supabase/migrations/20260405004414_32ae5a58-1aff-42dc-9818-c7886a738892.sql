...
-- Update the leaderboard view to include university and streak data
...
-- Update the filtered function to include university, streak, and semester filter
CREATE OR REPLACE FUNCTION public.get_leaderboard_filtered(time_filter text DEFAULT 'all', semester_filter integer DEFAULT NULL)
RETURNS TABLE(
  user_id uuid,
  display_name text,
  avatar_url text,
